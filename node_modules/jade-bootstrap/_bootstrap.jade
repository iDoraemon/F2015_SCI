...
html(lang="en")
    head
        ...
        meta(name="description",content="NodeJS Prototype")
        meta(name="author",content="Le Minh Pham Hoang")
        link(rel="icon",href="doraemon-bell.png")
        title= title
        block styles
        ...
        block scripts
            script(async src="https://ajax.googleapis.com/ajax/libs/jquery/1.11.2/jquery.min.js")
            script(async src="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.4/js/bootstrap.min.js")
            script(async src="https://cdnjs.cloudflare.com/ajax/libs/jquery-form-validator/2.2.8/jquery.form-validator.min.js")
            script(async src="javascripts/execute.js")
    body(data-spy="scroll",data-target=".scrollspy")
        block body
        footer.footer
            .container
                p.text-muted Le Minh Pham Hoang - SE03035 - CS0801 - FPT University